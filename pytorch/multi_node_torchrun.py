...
def load_train_objs():
    train_set = MyTrainDataset(2048, feature_dim=20, num_class=1)
...
def main(save_every: int, total_epochs: int, batch_size: int):
    ...
    destroy_process_group() # Clean exit of the processes
...
if __name__ == "__main__":
    ...
    # Example run:
    # torchrun --standalone --nproc_per_node=2 multi_gpu_torchrun.py 10 10